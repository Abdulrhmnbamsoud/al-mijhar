            ...
            questions: {
              ...
              items: {
                ...
                properties: {
                  ...
                  question: { type: "string" },
                  purpose: { type: "string" },
                  expectedEvasion: { type: "string" },
                  followUp: { type: "string" },
                  pressureLevel: { type: "number" }
                },
                required: ["category", "question", "purpose", "expectedEvasion", "followUp", "pressureLevel"],
                additionalProperties: false
              }
            },
            networkNodes: {
